#---------------------------------------------------------------------------------------------------------------------#
# This is same as Global AlexNet except that it is trained on a particular Saffir-Simpson wind scale category (Line: 225-246)
#---------------------------------------------------------------------------------------------------------------------#
#                                                  IMPORTS                                                            #
#---------------------------------------------------------------------------------------------------------------------#
import os
...
def filter_and_sort_csv(csv_file_path):
    ...
    # Subtask-5: Superstrong > 95
    #df_filtered = df[df['Wind Speed'] >= 96]
    df_filtered = df[df['Wind Speed'] >= 90]
