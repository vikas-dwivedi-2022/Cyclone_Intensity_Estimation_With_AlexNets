...
def filter_and_sort_csv(csv_file_path):
    ...
    # Subtask-1: Weak (15-33)
    #df_filtered = df[(df['Wind Speed'] >= 15) & (df['Wind Speed'] <= 33)]  # Non-intersecting
    df_filtered = df[(df['Wind Speed'] >= 15) & (df['Wind Speed'] <= 43)]   # Intersecting
