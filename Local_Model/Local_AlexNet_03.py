#---------------------------------------------------------------------------------------------------------------------#
# This is same as Global AlexNet except that it is trained on a particular Saffir-Simpson wind scale category (Line: 225-245)
#---------------------------------------------------------------------------------------------------------------------#
#                                                  IMPORTS                                                            #
#---------------------------------------------------------------------------------------------------------------------#
import os
...
def filter_and_sort_csv(csv_file_path):
    ...
    # Subtask-3: Medium-2 (64-82)
    #df_filtered = df[(df['Wind Speed'] >= 64) & (df['Wind Speed'] <= 82)]
    df_filtered = df[(df['Wind Speed'] >= 54) & (df['Wind Speed'] <= 86)]
